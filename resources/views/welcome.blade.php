        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-24">
                ...
                <div class="flex items-center gap-4 md:gap-6">
                    ...
                    <img src="{{ asset('images/logo-gihes.png') }}" alt="GIHES 2026" class="h-12 md:h-14 w-auto object-contain min-w-[100px]" onerror="this.outerHTML='<div class=\'h-12 w-28 bg-gray-200 border border-gray-300 flex items-center justify-center text-[10px] text-gray-500 rounded\'>Logo GIHES</div>'">
                </div>
